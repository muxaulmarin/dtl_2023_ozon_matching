...
python $workflow split-data-for-cv-v6 --data-dir $experiment_folder/$experiment --n-folds $n_folds
...
do
    ...
    do
        ...
        python $workflow create-dataset-$experiment --data-dir $experiment_folder/$experiment/cv_$fold --fold-type $fold_type
    done

    python $workflow fit-model-$experiment --data-dir $experiment_folder/$experiment/cv_$fold --params-version $experiment
    python $workflow predict-$experiment --data-dir $experiment_folder/$experiment/cv_$fold --params-version $experiment
    python $workflow evaluate --data-dir $experiment_folder/$experiment/cv_$fold --fold-type test --n-folds $n_folds
done
